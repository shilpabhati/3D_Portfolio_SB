...
const handleSubmit =(e) => {
  e.preventDefault();
  setLoading(true);
  emailjs.send('service_wmesl5m', 'template_tfk92ky', {
    from_name: form.name,
    to_name: 'Shilpa Bhati',
    from_email: form.email,
    to_email: 'shilpabhati2001@gmail.com',
  ...
  return (
    <div className='xl:mt-12 flex xl:flex-row flex-col-reverse flex-gap overflow-hidden'>
